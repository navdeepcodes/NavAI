...
These terms are an agreement between you and {publisher} about using Mike.
By installing or using Mike you agree to them. If you don't agree, please don't
use Mike.

## 1. Using Mike

{publisher} gives you a personal, non-exclusive, non-transferable licence to
install and use Mike on computers you own or control, for your own personal,
educational or work purposes, subject to these terms.
...
- **Check anything important.** Don't rely on Mike for medical, legal,
  financial, safety or other professional advice.
- **Studying.** Use Mike to learn and understand. You are responsible for
  following your school's or university's rules on academic integrity,
...
- Anything that can't be quietly undone is shown to you before it happens;
  **you decide whether to approve it**, and you're responsible for the actions
  you approve.
- Mike can misunderstand a request or a screen. Watch what it does, stop it
...
- access computers, accounts or data you're not authorised to access;
- send spam, harass people, or impersonate someone;
...
loss of data, files, profits or goodwill, arising from your use of Mike —
...
right to use your local courts.
